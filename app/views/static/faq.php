...
<body>
	...
	<div class="detail-hero-section container fluid bg-cyan pl-0 pr-0" style="
				background-image: url(<?php echo URLROOT . '/public/updated/img/static/frequently-asked-questions.webp' ?>);
	...
	<!-- End of Hero Section -->
	<div class="faq container mt-3 mb-3">
			...
			<div class="col-12-xs">
				...
				<div class="question">
					<h3 class="question-title">
						What is the difference between a FlexGuru and a regular
						educational website?
					</h3>
					<p class="question-content">
				...
				<div class="question">
					...
					<p class="question-content">
						...
						<b>Make special Requests.</b><br><br>
						...
						<br><br>
						<b>Visit the Marketplace and buy tutor service gigs.</b><br><br>
