...
<head>
    ...
    <title>Affiliate Marketer Registration</title>
...
<body>
    ...
    <div class="container student-registration pt-lg-4 pt-xs-2 pb-4">
        <div class="row">
            ...
            <form action="<?php echo URLROOT; ?>/registration/affiliate" method="POST" class="form-control row" style="width: 100%">
    ...
    <!-- End of Affiliate Marketer Registration  -->
