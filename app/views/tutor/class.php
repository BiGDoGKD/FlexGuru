...
<head>
    ...
    <title><?php echo 'Class | ' . $data['class']->classid . ' ' . $_SESSION['userdata']['firstname'] . ' ' . $_SESSION['userdata']['lastname'] ?></title>
                ...
                <div class="col-12-xs col-10-lg">
                    ...
                    <section class="chat-area">
                        ...
                        <form action="#" class="typing-area">
                            <input type="hidden" name="userone" value="<?php echo $data['class']->tutoruserid; ?>" />
                            <input type="hidden" name="usertwo" value="<?php echo $data['class']->studentuserid; ?>" />
                    ...
                    <script>
                        ...
                        let userone = <?php echo json_encode($data['class']->tutoruserid) ?>;
                        let usertwo = <?php echo json_encode($data['class']->studentuserid) ?>;
    ...
    <script>
        const countdown = () => {
            const countDate = <?php if ($data['class']->reviewphase && !$data['class']->sturating && $data['class']->turating) {
                                    ...
                                    echo strtotime($data['class']->reviewdeadline) * 1000;
                                } else if ($data['class']->status == 'pending' && !$data['class']->reviewphase) {
                                    echo strtotime($data['class']->deadline) * 1000;
                                } ?>;
