            ...
            <div class="half">
                <label for="profile2" class="profile-dropdown align-items-center">
                    ...
                    <ul class="profile-dropdown-list shadow-md">
                        <li>
                            <a href="<?php echo URLROOT ?>/tutor"><i class="mdi mdi-account"></i>Account</a>
                        </li>
                        <li>
                            <a href="<?php echo URLROOT ?>/tutor/settings"><i class="mdi mdi-settings"></i>Settings</a>
                        </li>
                        <li>
                            <a href="<?php echo URLROOT ?>/tutor/purchasehistory"><i class="mdi mdi-logout"></i>Purchase History</a>
                        </li>
                        <li>
                            <a href="<?php echo URLROOT ?>/tutor/complaint"><i class="mdi mdi-logout"></i>Complaints</a>
                        </li>
                        <li>
                            <a href="<?php echo URLROOT ?>/tutor/help"><i class="mdi mdi-logout"></i>Help</a>
                        </li>
                        <li>
